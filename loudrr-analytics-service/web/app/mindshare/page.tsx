...
export const metadata: Metadata = {
  title: "Mindshare",
  description: "Share of voice across crypto X — coming soon.",
};
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="glass-card relative overflow-hidden p-10 text-center sm:p-14">
        ...
        <h1 className="relative mt-5 font-display text-3xl font-extrabold tracking-tightest">Mindshare arena</h1>
        ...
        <p className="relative mx-auto mt-4 max-w-md text-bone-400">
          Share-of-voice across crypto X — top voices &amp; companies. In active build; join the community for early
          access.
        </p>

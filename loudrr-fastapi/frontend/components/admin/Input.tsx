...
const baseClasses = 'w-full rounded-lg border border-white/[0.08] bg-[#0a0a0a] px-3 py-2 text-sm text-white placeholder:text-zinc-500 focus:border-[#f95400]/40 focus:outline-none focus:ring-1 focus:ring-[#f95400]/40 disabled:opacity-50';
